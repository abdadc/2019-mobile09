package com.example.recyclerviewtextgrid.adapters;
...
import com.example.recyclerviewtextgrid.R;
import com.example.recyclerviewtextgrid.models.SuperHero;
...
public class SuperHeroAdapter extends RecyclerView.Adapter<SuperHeroAdapter.MyViewHolder> {
    ...
    public SuperHeroAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View superHeroView = layoutInflater.inflate(R
                .layout.item_super_hero, parent,false);
